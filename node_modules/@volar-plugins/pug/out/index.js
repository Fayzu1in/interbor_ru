...
module.exports = () => (context) => {
    ...
    return Object.assign(Object.assign({}, htmlPlugin), { getPugLs: () => pugLs, getPugDocument, rules: {
        ...
        findDocumentSymbols(document) {
            return worker(document, (pugDoc) => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                const htmlResult = (_b = yield ((_a = htmlPlugin.findDocumentSymbols) === null || _a === void 0 ? void 0 : _a.call(htmlPlugin, pugDoc.map.virtualFileDocument))) !== null && _b !== void 0 ? _b : [];
